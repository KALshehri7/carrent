...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(!empty($_POST['username']) && !empty($_POST['password'])) {
        ...
        $results = $q->getCarDealerByUsername($_POST['username']);
        // checks username
        if(!empty($results)) {
    ...
    if($exists == '1') {
        ...
        $_SESSION['carDealerUsername'] = $_POST['username'];
    }
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-8" style="width: 100%;">
                    <div class="alert alert-info text-center">
                        <?php echo 'Loading, please wait.';header( "refresh:1; url=dashboard.php?username=".$_SESSION['carDealerUsername']."" );?>
                    </div>
                </div>
                <div class="col-sm-2"></div>
            </div>
