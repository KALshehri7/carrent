...
class Vehicle implements JsonSerializable
{
     ...
     * @param $_carDealerId
     */
    public function __construct($_vehicleId, $_make, $_yearMade, $_model, $_price, $_mileage, $_transmission, $_drivetrain, $_engineCapacity, $_category, $_cylinder, $_doors, $_status, $_dateAdded,$_carDealerId)
    {
        ...
        $this->_carDealerId = $_carDealerId;
    }
    ...
    {
        return $this->_carDealerId;
    }

    /**
     * @param mixed $carDealerId
     */
    public function setCarDealerId($carDealerId)
    {
        $this->_carDealerId = $carDealerId;
    }
