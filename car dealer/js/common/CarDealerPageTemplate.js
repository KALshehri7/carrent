class CarDealerPageTemplate {

  static footer() {
    let currentYear = (new Date().getYear()) + "";
    return `<footer class="templatemo-footer">   
               <div class="templatemo-copyright">   
               <p>Copyright  @20${currentYear.substr(1)} Car Shopping Project</p>   
               </div>   
            </footer>`;
  }
    ...
    return `
        <div class="navbar-collapse collapse templatemo-sidebar">   
          <ul class="templatemo-sidebar-menu">   
            ...
            <li><a href="orders.php?username=${username}"><i class="fa fa-shopping-cart"></i>Manage Orders</a></li>   
