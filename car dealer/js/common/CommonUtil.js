function CommonUtil() {
  ...
  this.pageName = [
    {name: "dashboard.php", title: "Car Dealer - Dashboard"},
    {name: "inventory.php", title: "Manage Vehicles"},
    {name: "orders.php", title: "Manage Orders"},
    {name: "preferences.php", title: "Account settings"},
    {name: "sign-in.php", title: "Car Dealer login"},
    {name: "register.php", title: "Car Dealer registration"},
